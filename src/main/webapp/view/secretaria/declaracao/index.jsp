...
<head>
    ...
    <title>OJJ Académico • Emissão de Declarações</title>
            ...
            <div class="col-md-6">
                <div class="card-custom">
                    <div class="card-header">
                        <h4><i class="fas fa-file-pdf"></i> Emissão de Declaração</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <p>Informe o número do estudante para gerar a declaração de frequência/matrícula.</p>
