    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-12 d-flex justify-content-between align-items-center">
                <div>
                    <h2 style="color: white;"><i class="fas fa-coins"></i> Bem-vindo(a), ${sessionScope.nomeUsuario}</h2>
                    <p style="color: rgba(255, 255, 255, 0.8);">Painel Financeiro • Controlo de propinas e serviços institucionais.</p>
                </div>
